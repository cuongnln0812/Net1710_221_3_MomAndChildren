...
namespace MomAndChildren.Data
{
    public class UnitOfWork
    {
        ...
        {
            get { return _orderDetail ??= new Repositories.OrderDetailRepository(_unitOfWorkContext); }
        }
        public CategoryRepository CategoryRepository
        {
            get { return _category ??= new Repositories.CategoryRepository(_unitOfWorkContext); }
        }

        public ProductRepository ProductRepository
        {
            get { return _product ??= new Repositories.ProductRepository(_unitOfWorkContext); }
        }

        public BrandRepository BrandRepository
        {
            get { return _brand ??= new Repositories.BrandRepository(_unitOfWorkContext); }
        }
